...
public class VentanaRegistro extends javax.swing.JFrame {
 public static ArrayList<Object> jugadores = new ArrayList<>();
    ...
    public void llenarGrid(){
        if(jugadores.size() > 0){
            ...
            for(int i = 0; i < jugadores.size(); i ++){
                ...
                Object jugadoresN [] = {jug.getId(),jug.getNombre(),jug.getApellido(),jug.getCedula() , jug.getUsuario(),jug.getContadorV()};
    ...
    private void initComponents() {
        ...
        btnVolver.setText("Volver a Seleccion de personajes");
        btnVolver.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnVolverActionPerformed(evt);
            }
        });
        getContentPane().add(btnVolver, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 390, -1, -1));
    ...
    private void btnCrearActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCrearActionPerformed
        ...
        ClsJugadores jugador = new ClsJugadores(cont, txtNombre.getText(),txtApellido.getText(), txtCedula.getText(), txtUsuario.getText(), Victorias);
        cont++;
        UsuarioExiste = true;
        for(Object mObj : jugadores) {
            ClsJugadores m = (ClsJugadores) mObj;
            if(m.getUsuario().equals(jugador.getUsuario()) || m.getCedula().equals(jugador.getCedula())) {
                UsuarioExiste = false;
                break;
            }
        }
        ...
        Object jugadoresN [] = {jugador.getId(),jugador.getNombre(),jugador.getApellido(),jugador.getCedula() , jugador.getUsuario(), jugador.getContadorV()};
        DefaultTableModel model = (DefaultTableModel) tblJugadores.getModel();
